...
Sou desenvolvedor com foco em criação de APIs, automação e aplicações mobile. Trabalho com tecnologias modernas para transformar ideias em projetos funcionais, sempre buscando código limpo, boa arquitetura e experiência do usuário.

- 💡 Apaixonado por resolver problemas com software.
...
- **Dart / Flutter:** aplicativos mobile e interfaces rápidas.
- **Banco de Dados:** SQLite, MySQL, Postgres.
- **Ferramentas:** Git, Linux, Docker básico.

## 🚀 O que venho estudando

- APIs escaláveis com **FastAPI** e **Express**.
